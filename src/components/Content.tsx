...
const ContactForm: React.FC = () => {
  ...
  return (
    <div className="max-w-md w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-8 shadow-input bg-white dark:bg-black ">
      <h1 className="relative mt-10 text-4xl md:text-6xl lg:text-7xl mb-10 font-bold w-full m-auto flex justify-center items-center">Contact</h1>
      <form className="my-8" onSubmit={handleSubmit}>
        <div className="flex flex-col space-y-2 mb-4">
          ...
          <input
            ...
            className="input-class border rounded-lg p-2 text-black"
          />
        </div>
        <div className="flex flex-col space-y-2 mb-4">
          ...
          <input
            ...
            onChange={handleChange}
            className="input-class rounded-lg border p-2 text-black"
          />
        </div>
        <div className="flex flex-col space-y-2 mb-4">
        ...
        <div className="flex flex-col space-y-2 mb-4">
          ...
          <textarea
            ...
            onChange={handleChange}
            className="input-class rounded-lg border p-2 text-black h-32"
          />
        </div>
        <button
