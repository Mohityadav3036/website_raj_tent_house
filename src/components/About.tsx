...
const About: React.FC = () => {
  ...
  return (
    <div className={`w-full py-10 ${isDarkMode ? 'bg-black text-white' : 'bg-white text-black'}`}>
      
      <h1 className="relative mt-10 text-4xl md:text-6xl lg:text-7xl mb-10 font-bold w-full m-auto flex justify-center items-center">
        ABOUT
      </h1>
